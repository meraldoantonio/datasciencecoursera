...
#Afterwards, run the below code. It should take around 30 seconds. Then, the PNG file should then appear in that folder.
...
#plotting
hist(subset.pc$Global_reactive_power, col ="red", xlab = "Global Active Power (kilowatts)", ylab = "Frequency", main = "Global Active Power")
dev.copy(png, file = "plot1.png",  width=480, height=480)
dev.off()
cat("Plot1.png is generated and is stored in your current directory:",getwd())